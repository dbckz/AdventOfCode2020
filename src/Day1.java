...
public class Day1 {
    ...
    private List<Integer> calculate(List<Integer> input) {
    ...
    public static void main(String[] args) {
        ...
        Day1 day1 = new Day1();
        List<Integer> twoNumbers = day1.calculate(inputList);
        System.out.println(twoNumbers);
        System.out.println(day1.multiply(twoNumbers.get(0), twoNumbers.get(1)));

        List<Integer> threeNumbers = day1.calculateThree(inputList);
        System.out.println(threeNumbers);
        System.out.println(day1.multiplyThree(threeNumbers.get(0), threeNumbers.get(1), threeNumbers.get(2)));
    }
}