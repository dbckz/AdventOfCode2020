...
public class Day12 {
    ...
    private int calculate(List<String> input) {
        int x = 0;
        int y = 0;
        int direction = 0; // 0 = E; 90 = N; 180 = W; 270 = S
    ...
    private int calculate2(List<String> input) {
        int x = 0;
        int y = 0;
        int wayX = 10;
        int wayY = 1;
...
//        String input = "F10,N3,F7,R90,F11";
        ...
        int result1 = day12.calculate(inputList);
        int result2 = day12.calculate2(inputList);
